...
# Every chunk below benchmarks against rTensor and plots the result; skip
# evaluation when any of the suggested packages is unavailable.
has_deps <- all(vapply(
  c("bench", "dplyr", "ggplot2", "rTensor", "scales", "tidyr"),
...
```{r efficiency-comparison-2, message=FALSE, warning=FALSE}
set.seed(123)
...
```{r multiple-matrix-benchmark-2, message=FALSE, warning=FALSE}
set.seed(456)
...
```{r scalability-benchmark-2, message=FALSE, warning=FALSE}
set.seed(101112)
